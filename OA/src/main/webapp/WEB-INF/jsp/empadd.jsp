...
<head>
    ...
    <script>
        function addEmp() {
            $.post("/addEmp",$('#addEmpForm').serialize(),function (data) {
                if(data.status==200){
                    alert(data.message);
                }else{
                    alert(data.message);
...
<div class="layui-container" style="margin-top: 5px">
    <form class="layui-form" id="addEmpForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <img alt="个人一寸照片" src="media/upload/no.jpg" id="img1" width="200px" height="300px">
            </div>
        </div>
        <div class="layui-form-item">
